...
namespace {
  void reorder_for_consistency(unsigned &index1, unsigned &id1, unsigned &index2,
                               unsigned &id2) {
...
std::string message::segment_collision(unsigned id1, unsigned index1, unsigned id2,
                                       unsigned index2) {
...
std::string message::success() { return string("Correct file\n"); }
